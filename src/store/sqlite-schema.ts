...
export const SQLITE_TABLES: ReadonlyArray<string> = [
  ...
  `CREATE TABLE IF NOT EXISTS iteam_delivery_artifacts (
    id            TEXT NOT NULL PRIMARY KEY,
    space_id      TEXT NOT NULL DEFAULT 'space_default',
    delivery_id   TEXT NOT NULL,
    event_id      TEXT,
...
export const SQLITE_INDEXES: ReadonlyArray<string> = [
  ...
  "CREATE INDEX IF NOT EXISTS idx_delivery_artifacts_delivery ON iteam_delivery_artifacts(delivery_id, created_at)",
  "CREATE INDEX IF NOT EXISTS idx_delivery_artifacts_event ON iteam_delivery_artifacts(event_id)",
  "CREATE INDEX IF NOT EXISTS idx_delivery_artifacts_target ON iteam_delivery_artifacts(space_id, target, created_at)",
