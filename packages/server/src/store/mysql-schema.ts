...
export const MYSQL_TABLES: ReadonlyArray<{ name: string; ddl: string }> = [
  ...
  },
  {
    ...
    ddl: `CREATE TABLE IF NOT EXISTS iteam_agents (
      ...
      share_runtime_history TINYINT(1) NOT NULL DEFAULT 0,
  ...
  {
    name: "iteam_delivery_artifacts",
    ddl: `CREATE TABLE IF NOT EXISTS iteam_delivery_artifacts (
      id            VARCHAR(64)  NOT NULL PRIMARY KEY,
      space_id      VARCHAR(64)  NOT NULL DEFAULT 'space_default',
      delivery_id   VARCHAR(64)  NOT NULL,
      ...
      storage       VARCHAR(32)  NOT NULL DEFAULT 'db',
  ...
  },
  {
    ...
    ddl: `CREATE TABLE IF NOT EXISTS iteam_external_message_links (
      ...
      external_root_message_id VARCHAR(255) DEFAULT NULL,
      external_parent_message_id VARCHAR(255) DEFAULT NULL,
      external_reply_to_message_id VARCHAR(255) DEFAULT NULL,
      message_id               VARCHAR(64)  NOT NULL,
